...
from playwright.sync_api import Browser, BrowserContext, Page, Route, Request
from openai import OpenAI
from dotenv import load_dotenv
from urllib.parse import urljoin, urlparse, urlunparse
from typing import Optional, List, Tuple, Dict, Any
from worker_sync.worker_types import Job
...
class BaseScraper:
    ...
    def __init__(
        ...
        self.context, self.page = self.create_context_with_proxy()
    ...
    def intercept_requests(self, route: Route, request: Request, media_extensions: list[str], blocked_ads: list[str]):
    ...
    def create_context_with_proxy(self) -> Tuple[BrowserContext, Page]:
        ...
        context.route("**/*", lambda route, request: self.intercept_requests(route, request, media_extensions, blocked_ads))
    ...
    def clean_contexts_playwright(self) -> None:
        """Closes all Playwright contexts and the browser safely."""
        try:
    ...
    def extract_structured_text(
        self, soup: BeautifulSoup, url: str, job_offers: List[Job] = [], skip_existing_jobs: bool = True
    ) -> str:
        """
