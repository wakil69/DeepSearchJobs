...
class FindCompanyLogo:
    def __init__(self, page, logger, company_name: str, company_id: int):
        self.page = page 
    ...
    def get_company_logo_url(self) -> Optional[str]:
        """
        ...
        try:
            ...
            # Go to Google Images
            self.page.goto(google_images_url, timeout=25000, wait_until="domcontentloaded")
            ...
            logo_url = locator.first.get_attribute("src")
