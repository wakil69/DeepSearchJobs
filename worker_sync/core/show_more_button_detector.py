...
from worker_sync.core.prompts import PROMPT_IDENTIFY_SHOW_MORE_BUTTON_TEXT
...
class ShowMoreButtonDetector:
    ...
    def check_if_show_more_pagination_button(
        ...
        try:
            ...
            show_more_button = self.extract_show_more_button(soup, url)
            ...
            if retries > 0:
                ...
                return self.check_if_show_more_pagination_button(
    ...
    def click_button_load_more(self, button_text: str, timeout=5000):
        """
        ...
        try:
            ...
            for xpath in candidate_xpaths:
                try:
                    ...
                    self.logger.warning(f"XPath candidate {xpath} not valid in live DOM: {e}")
                    continue
    ...
    def process_page_with_show_more_button(
        ...
        while True:
            try:
                ...
                if not self.click_button_load_more(button_text):
                    self.logger.info(
                ...
                # random jitter to mimic human delay
